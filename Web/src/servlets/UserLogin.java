...
import static constants.Constants.WORKER;
...
public class UserLogin extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        if (usernameFromSession == null) { //user is not logged in yet
            ...
            int money = Integer.parseInt(request.getParameter(Constants.MONEY));
            int numOfThreads = Integer.parseInt(request.getParameter(Constants.NUM_OF_THREADS));
            String typeUser = request.getParameter(Constants.USER_TYPE);
                ...
                synchronized (this) {
                    if (userManager.isUserExists(usernameFromParameter)) {
                        ...
                        if(typeUser.equals(ADMIN)){
                            userManager.addUser(usernameFromParameter,typeUser);
                        }else if(typeUser.equals(WORKER)){
                            userManager.addUser(usernameFromParameter,typeUser,numOfThreads,money);
                        }
